  ...
  return (
    <header className="w-full sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex items-center justify-between">
        ...
        >
          <span>Book</span>
          <span className="bg-red-500 text-white px-1.5 mx-1 rounded-md">My</span>
          <span>Seat</span>
        </div>
              ...
              {open && (
                <div className="absolute right-0 mt-3 w-64 bg-white shadow-lg rounded-xl border p-4 z-50">
                  ...
                  <button
                    ...
                    className="w-full text-left text-red-500 font-medium hover:bg-red-50 px-2 py-1 rounded"
                  >
                    Logout
                  </button>
